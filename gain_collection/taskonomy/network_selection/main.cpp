...
//the main network is here
// given candidates runnning_solution
// remaining budget
...
vector<double> compute_and_print(vector<Model> &performances, vector<Model> & performances_test_set, bool print=true) {
    if(print)
